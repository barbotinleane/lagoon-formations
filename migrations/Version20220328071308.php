...
final class Version20220328071308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE asks_stagiaire (asks_id INT NOT NULL, stagiaire_id INT NOT NULL, INDEX IDX_1823C57C3373B24C (asks_id), INDEX IDX_1823C57CBBA93DD6 (stagiaire_id), PRIMARY KEY(asks_id, stagiaire_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
